...
class WardDawat1RegularGroupWiseController extends Controller
{
    ...
    {
        return ward_common_get(WardDawat1RegularGroupWise::class);
    }
    ...
    public function all()
    {
        ...
        $query = WardDawat1RegularGroupWise::where('status', $status)->orderBy($orderBy, $orderByType);
    ...
    public function show($id)
    {
        ...
        $data = WardDawat1RegularGroupWise::where('id', $id)
            ->select($select)
            ->first();
        if ($data) {
    ...
    public function store()
    {
        ...
        $data = new WardDawat1RegularGroupWise();
    ...
    {
        $data = WardDawat1RegularGroupWise::find(request()->id);
        if (!$data) {
            return response()->json([
                'err_message' => 'validation error',
    ...
    {
        $validator = Validator::make(request()->all(), [
            'id' => ['required', 'exists:ward_dawat1_regular_group_wises,id'],
        ]);
