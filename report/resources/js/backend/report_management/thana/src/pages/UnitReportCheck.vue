    ...
    <div id="report_uplode_body">
        <section id="heading" class="mt-3">
            ...
            <div class="unit_info">
                ...
                <div class="line d-flex flex-wrap justify-content-between mb-1">
                    <p>
                        ইউনিটের নাম: {{ report_header?.unit_info?.title || "" }}
                    </p>
                    <p>
                        ওয়ার্ড নং ও নাম:
                ...
                <div class="line d-flex flex-wrap justify-content-between">
                    <p>
                        ইউনিট সভাপতির নাম: {{ report_header?.president || "" }}
                    </p>
                    <p class="width-30">
                        ইউনিটের ধরন: {{ report_header?.org_type || "" }}
                    </p>
                </div>
            </div>
        </section>
        ...
        <section id="report">
            <div class="dawat mt-1">
                ...
                <div
                    class="jonoshadharon d-flex flex-wrap justify-content-between mb-2"
                >
                    <p class="fw-bold w-75">
                        ক) জনসাধারণের মাঝে সর্বমোট দাওয়াত প্রদান সংখ্যা* :
                        <span>{{ total_dawat }}</span>
                    </p>
                    <p class="fw-bold w-25">
                        টার্গেট:
                        <span>{{
                            formatBangla(
                                report_sum_data?.dawat5_jonoshadharons
                                    ?.jonoshadharon_dawat_target
                            )
                        }}</span>
                    </p>
                </div>
            ...
            <div class="job_holder">
                <h4 class="fs-6">
                    ২. বিভিন্ন শ্রেণি-পেশার মানুষের মাঝে দাওয়াত
                </h4>
                <table class="text-center mb-1">
                    <thead>
                        <tr>
            ...
            <div class="poribar mb-2">
                ...
                <table class="text-center mb-1 table_layout_fixed">
                    <thead>
                        <tr>
                            <th class="">
                                দাওয়াতি কাজে অংশগ্রহণকারী পরিবার সংখ্যা
                            </th>
                            <th class="">
                                কতটি নতুন পরিবারে দাওয়াত পৌঁছানো হয়েছে
                            </th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <div class="dawah_prokashona">
                <table class="text-center mb-1">
                    ...
                    <tbody>
                        <tr>
                            <td class="text-start px-2">বই বিলিকেন্দ্র</td>
                            <td>
                                <div class="parent_popup">
                                    {{
                                        formatBangla(
                        ...
                        <tr>
                            ...
                            <td class="text-start px-2">
                                দাওয়াতি লিংক বিতরণ<span>(সংগঠন অনুমোদিত)</span>
                            </td>
                            <td>
                                <div class="parent_popup">
                                    {{
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="parent_popup">
                                    {{
                                        formatBangla(
                                            average_kormosuci.unit_masik_sadaron_sova
                                        )
                                    }}
                                    <comment
                                        :table_name="'kormosuci_bastobayons'"
                            ...
                            <td>
                                <div class="d-flex justify-content-evenly">
                                    <div class="parent_popup">
                                        {{
                                            formatBangla(
                                                average_kormosuci.iftar_mahfil_personal
                                            )
                                        }}
                                        <comment
                                            :table_name="'kormosuci_bastobayons'"
                                    ...
                                    <div class="parent_popup">
                                        {{
                                            formatBangla(
                                                average_kormosuci.iftar_mahfil_samostic
                                            )
                                        }}
                                        <comment
                                            :table_name="'kormosuci_bastobayons'"
                            ...
                            <td>
                                <div class="d-flex justify-content-evenly">
                                    ...
                                    <div class="parent_popup">
                                        {{
                                            formatBangla(
                                                average_kormosuci.samostic_khawa
                                            )
                                        }}
                                        <comment
                                            :table_name="'kormosuci_bastobayons'"
                                    ...
                                    <div class="parent_popup">
                                        {{
                                            formatBangla(
                                                average_kormosuci.sikkha_sofor
                                            )
                                        }}
                                        <comment
                                            :table_name="'kormosuci_bastobayons'"
        ...
        <section class="margine_top_page_change">
            <div class="songothon">
                ...
                <div class="shohojogi mb-2">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    {{
                                        formatBangla(
                                            previous_present?.associate_member_previous ??
                                                ""
                                        )
                                    }}
                                </td>
                                <td>
                                    {{
                                        formatBangla(
                                            previous_present?.associate_member_present ??
                                                ""
                                        )
                                    }}
                                </td>
                            ...
                            <tr>
                                <td class="text-start px-2">
                                    ভিন্নধর্মাবলম্বী কর্মী/সহযোগী সদস্য
                                </td>
                                <td>
                                    <div class="d-flex justify-content-center">
                                        {{
                                            formatBangla(
                                                previous_present?.vinno_dormalombi_worker_previous ??
                                                    ""
                                            )
                                        }}/
                                        {{
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        {{
                                            formatBangla(
                                                previous_present?.vinno_dormalombi_worker_present ??
                                                    ""
                                            )
                                        }}/
                                        {{
                                        ...
                                        <div class="parent_popup">
                                            {{
                                                formatBangla(
                                                    report_sum_data
                                                        ?.songothon2_associate_members
                                                        ?.vinno_dormalombi_worker_target ??
                                                        ""
                                                )
                                            }}
                                            <comment
                    ...
                    <p>
                        *দাওয়াত ও তাবলিগের 'ক' এর অধীনে উল্লেখিত সকল সহযোগী
                        সদস্যের সংখ্যা এ ছকে সহযোগী সদস্যের ঘরে বসাতে হবে।
                    </p>
                </div>
                <div
                    class="kormi_boithok d-flex flex-wrap justify-content-between mb-1"
                >
                    <div class="d-flex justify-content-start w-50">
                        <label for="" class="fw-bold fs-6"
                            >৩. মাসিক কর্মী বৈঠক সংখ্যা :</label
                        >
                ...
                <div class="paribaik_unit mb-2">
                    ...
                    <p>
                        * পরিবারের জনশক্তি পুরুষ ও মহিলা উভয় হলে পারিবারিক
                        ইউনিটের হিসাব একবারই আসবে।
                    </p>
                </div>
                <div class="urdotono mb-1">
                    <div class="d-flex justify-content-start">
                        <label for="" class="fw-bold fs-6"
                            >৫. ঊর্ধ্বতন দায়িত্বশীলদের সফর সংখ্যা :</label
                        >
                        <div class="parent_popup w-75 border_dot">
                            {{
                                formatBangla(
                                    report_sum_data?.songothon7_sofors
                                        ?.upper_leader_sofor ?? ""
                                )
                            }}
                            <comment
                                :table_name="'songothon7_sofors'"
            ...
            <div class="proshikkhon mb-2">
                <table class="text-center mb-1">
                    ...
                    <tbody>
                        <tr>
                            <td class="text-start px-2">
                                তারবিয়াতী বৈঠক (সহীহ কুরআন
                                অনুশীলন/মাসয়ালা-মাসায়েল/ দারসে কুরআন/ দারসে
                                হাদীস / সামষ্টিক পাঠ/বিষয়ভিত্তিক আলোচনা)
                            </td>
                            <td>
                                <div class="d-flex justify-content-evenly">
                                    <div class="parent_popup">
                                        {{
                                            formatBangla(
                                                report_sum_data
                                                    ...
                                                    ?.sohi_quran_onushilon ?? ""
                                            )
                                        }}
                                        <comment
                                            :table_name="'proshikkhon1_tarbiats'"
                                    ...
                                    <div class="parent_popup">
                                        {{
                                            formatBangla(
                                                report_sum_data
                                                    ?.proshikkhon1_tarbiats
                                                    ?.bishoy_vittik_onushilon_target ??
                                                    ""
                                            )
                                        }}
                                        <comment
                                    ...
                                    <div class="parent_popup">
                                        {{
                                            formatBangla(
                                                report_sum_data
                                                    ?.proshikkhon1_tarbiats
                                                    ?.sohi_quran_onushilon_uposthiti ??
                                                    ""
                                            )
                                        }}
                                        <comment
                                    ...
                                    <div class="parent_popup">
                                        {{
                                            formatBangla(
                                                report_sum_data
                                                    ?.proshikkhon1_tarbiats
                                                    ?.bishoy_vittik_onushilon_uposthiti ??
                                                    ""
                                            )
                                        }}
                                        <comment
                ...
                <div class="unit_shamajik_kaj mb-2">
                    ...
                    <table class="text-center mb-1">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-start px-2">
                                    সামাজিক অনুষ্ঠানে অংশগ্রহন/সহায়তা প্রদান
                                </td>
                                <td>
                                    <div class="d-flex justify-content-evenly">
                                        <div class="parent_popup">
                            ...
                            <tr>
                                ...
                                <td class="text-start px-2">
                                    মাতৃত্বকালীন সময়ে সেবা প্রদান (কতজন/কতজনকে)
                                </td>
                                <td>
                                    <div class="d-flex justify-content-evenly">
                                        <div class="parent_popup">
                                            {{
                                                formatBangla(
                                                    report_sum_data
                                                        ?.shomajsheba2_unit_social_works
                                                        ?.matrikalin_sheba_prodan_kotojon ??
                                                        ""
                                                )
                                            }}
                                            <comment
                                        ...
                                        <div class="parent_popup">
                                            {{
                                                formatBangla(
                                                    report_sum_data
                                                        ?.shomajsheba2_unit_social_works
                                                        ?.matrikalin_sheba_prodan_kotojonke ??
                                                        ""
                                                )
                                            }}
                                            <comment
                            ...
                            <tr>
                                <td class="text-start px-2">
                                    মানবিক সহায়তা/কর্জে হাসানা প্রদান (কতজনকে)
                                </td>
                                <td>
                                    <div class="d-flex justify-content-evenly">
                                        <div class="parent_popup">
            ...
            <div class="rartrio">
                ...
                <div class="bisisto mb-2">
                    <div class="d-flex justify-content-start">
                        <label for="" class=""
                            >বিশিষ্ট ব্যক্তিবর্গের সাথে যোগাযোগ সংখ্যা :</label
                        >
                        <div class="parent_popup ms-2 w-25 border_dot">
                            {{
                                formatBangla(
                                    report_sum_data?.rastrio1_bishishto_bektis
                                        ?.bishishto_bekti_jogajog ?? ""
                                )
                            }}
                            <comment
                                :table_name="'rastrio1_bishishto_bektis'"
            ...
            <div class="baytulmal">
                ...
                <p class="fs-6">
                    মাসিক ওয়াদার পরিমাণ :
                    <span>{{ formatBangla(nisab_dharjo?.amount ?? "") }}</span>
                    /=
                </p>
                <table class="text-center mb-1 table_layout_fixed">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ formatBangla(income_report?.total_amount) }}
                            </td>
                            <td class="text-end px-2">সর্বমোট</td>
                            <td>
                                {{ formatBangla(expense_report?.total_amount) }}
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="montobbo">
                ...
                <div class="parent_popup">
                    <p>
                        {{
                            report_sum_data?.montobbos?.montobbo ??
                            "মন্তব্য নাই"
                        }}
                    </p>
                    <comment
                        :table_name="'montobbos'"
                            ...
                            <form class="mb-2">
                                <div class="mb-2">
                                    ...
                                    <textarea
                                        ...
                                        id="comment"
                                        class="form-control"
                                        v-model="comment_text_store"
                                    ></textarea>
                                </div>
                                <a
                                    href="#"
                                    class="btn btn-success"
                                    @click.prevent="comment_set"
                                    >Add comment</a
                                >
                            </form>
                        </div>
                        <pre>{{
                            all_comment_store ? "" : "No data available"
                        }}</pre>
                        <!-- Debug output -->
                        <div
                            class="all_comment"
                            v-for="(comment, index) in all_comment_store"
                            :key="index"
                        >
                            <p>
                                <strong
...
export default {
    ...
    methods: {
        ...
        uploaded_data: async function () {
            ...
            let res = await axios.get("/unit/report-check", {
                params: {
                    month: month,
                    unit_id: unit_id,
                },
        ...
        average_data: async function () {
            if (this.report_sum_data.kormosuci_bastobayons) {
                ...
                fields.forEach((field) => {
                    ...
                    this.average_kormosuci[field] = Math.round(
                        (this.report_sum_data.kormosuci_bastobayons[
                            uposthitiKey
                        ] ?? 0) /
                            (this.report_sum_data.kormosuci_bastobayons[
                                totalKey
        ...
        formatBangla(input) {
            ...
            const number = Number(input); // Convert to number if it's a number-like string
        ...
        expense_store: function (bm_expense_category_id, amount) {
            ...
            axios
                .post("/bm-expense/store", formData)
                .then(function (response) {
                    window.toaster(
    ...
    computed: {
        ...
        total_dawat() {
            const total =
                (Number(
                    this.report_sum_data?.dawat1_regular_group_wises
                        ?.how_many_have_been_invited
                ) || 0) +
                (Number(
                    this.report_sum_data?.dawat2_personal_and_targets
                        ?.how_many_have_been_invited
                ) || 0) +
                (Number(
                    this.report_sum_data?.dawat3_general_program_and_others
                        ?.how_many_were_give_dawat
                ) || 0) +
                (Number(
                    this.report_sum_data?.dawat4_gono_songjog_and_dawat_ovijans
                        ?.how_many_have_been_invited
                ) || 0) +
                (Number(
                    this.report_sum_data?.dawat4_gono_songjog_and_dawat_ovijans
