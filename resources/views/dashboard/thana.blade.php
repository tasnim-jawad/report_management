...
<head>
    ...
    <link href="h  ttps://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    @vite('resources/js/backend/report_management/thana/main.js')
    <script>
