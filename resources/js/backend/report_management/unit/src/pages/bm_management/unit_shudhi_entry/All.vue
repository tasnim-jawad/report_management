                            ...
                            <td>
                                <div class="action">
                                    <div class="btn btn-success btn-sm me-2">
                                        <router-link :to="{name:'UnitShudhiEntryDetails',params: { entry_id: entry.id }}"  class="text-dark">show</router-link>
                                    </div>
                                    <div class="btn btn-warning btn-sm me-2" >
                                        <router-link :to="{name:'UnitShudhiEntryEdit',params: { entry_id: entry.id }}"  class="text-dark">Edit</router-link>
                                    </div>
...
export default {
    ...
    computed: {
        ...
        ...mapWritableState(unit_shudhi_entry_store, [
            'unit_shudhi_entry',
            'total_paid',
            'is_permitted',
        ]),
    ...
    methods:{
        ...mapActions(unit_shudhi_entry_store,{
            show_unit_shudhi_entry:'show_unit_shudhi_entry',
            delete_entry:'delete_entry',
            submit_delete_form:'submit_delete_form',
            unit_shudhi_entry_month_wise:'unit_shudhi_entry_month_wise',
        }),
