    ...
    <div class="card mb-2" v-if="month">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="btn btn-info btn-sm">
                <router-link :to="{name:'BmUserEntryCreate'}" class="text-dark">Create Entry</router-link>
            </div>
        </div>
        <div class="card-body">
                            ...
                            <td>
                                <div class="action">
                                    <div class="btn btn-success btn-sm me-2">
                                        <router-link :to="{name:'BmUserEntryDetails',params: { entry_id: entry.id }}"  class="text-dark">show</router-link>
                                    </div>
                                    <div class="btn btn-warning btn-sm me-2" >
                                        <router-link :to="{name:'BmUserEntryEdit',params: { entry_id: entry.id }}"  class="text-dark">Edit</router-link>
                                    </div>
...
export default {
    ...
    computed: {
        ...
        ...mapWritableState(bm_user_entry_store, [
            'bm_user_entry',
            'total_paid',
            'is_permitted'
        ]),
