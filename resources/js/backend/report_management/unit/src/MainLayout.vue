    ...
    <div id="report_app" class="report_app">
        ...
        <div class="report_app_right">
            <header class="report_app_right_top">
                ...
                <div class="right">
                    <notification-button
                        :unit_id="user?.responsibility?.org_unit?.id"
                    ></notification-button>
                    <a
                        class="btn"
                        href="#"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer d-flec justify-content-between">
                        ...
                        <a
                            ...
                            @click="
                                go_to_notification(
                                    user?.responsibility?.org_unit?.id
                                )
                            "
                        >
...
export default {
    ...
    mounted: async function () {
        let org_type = "unit";
        let unit_active_report = await axios
        ...
        this.isUnitReportPage = window.location.href.includes(
            "unit-report-upload-monthly"
        );
        ...
        if (!this.isUnitReportPage) {
            ...
            if (this.unit_active_report_month_info) {
                this.month = moment(
                    this.unit_active_report_month_info.month_year
                ).format("YYYY-MM");
