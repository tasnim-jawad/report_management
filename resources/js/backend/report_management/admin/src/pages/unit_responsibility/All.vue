    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="btn btn-info btn-sm">
                <router-link :to="{name:'UnitResponsibilityCreate'}" class="text-dark">নতুন দায়িত্ব তৈরি করুন </router-link>
            </div>
        </div>
        <div class="card-body">
                            ...
                            <td>
                                <div class="action">
                                    <div class="btn btn-success btn-sm me-2">
                                        <router-link :to="{name:'UnitResponsibilityDetails',params: { responsibility_id: category.id }}"  class="text-dark">show</router-link>
                                    </div>
                                    <div class="btn btn-warning btn-sm me-2">
                                        <router-link :to="{name:'UnitResponsibilityEdit',params: { responsibility_id: category.id }}"  class="text-dark">Edit</router-link>
                                    </div>
