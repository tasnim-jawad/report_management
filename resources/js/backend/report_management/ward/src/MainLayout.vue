...
export default {
    ...
    mounted: async function () {
        let org_type = "ward";
        let ward_active_report = await axios
        ...
        this.isWardReportPage = window.location.href.includes(
            "ward-report-upload-monthly"
        );
        ...
        if (!this.isWardReportPage) {
            ...
            if (this.ward_active_report_month_info) {
                this.month = moment(
                    this.ward_active_report_month_info.month_year
                ).format("YYYY-MM");
                modalElement.show();
            }
            // modalElement.show();
