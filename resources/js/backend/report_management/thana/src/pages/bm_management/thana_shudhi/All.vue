    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="btn btn-info btn-sm">
                <router-link :to="{name:'ThanaShudhiCreate'}" class="text-dark">নতুন সুধী তৈরি করুন</router-link>
            </div>
        </div>
        <div class="card-body">
                            ...
                            <td>
                                <div class="action">
                                    <div class="btn btn-success btn-sm me-2">
                                        <router-link v-if="shudhi && shudhi.id"  :to="{name:'ThanaShudhiDetails',params: { shudhi_id: shudhi.id }}"  class="text-dark">show</router-link>
                                    </div>
                                    <div class="btn btn-warning btn-sm me-2">
                                        <router-link v-if="shudhi && shudhi.id"  :to="{name:'ThanaShudhiEdit',params: { shudhi_id: shudhi.id }}"  class="text-dark">Edit</router-link>
                                    </div>
...
import { store as thana_shudhi_store } from "../../../stores/ThanaShudhiStore" 
...
export default {
    ...
    created:function(){
        this.all_thana_shudhi()
    },
    computed:{
        ...mapWritableState(thana_shudhi_store, [
            'all_shudhi'
        ]),
    },
    methods:{
        ...mapActions(thana_shudhi_store,{
            all_thana_shudhi:'all_thana_shudhi',
        }),
