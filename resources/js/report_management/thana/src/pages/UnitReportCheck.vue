                ...
                <table class="text-center  mb-1 table_layout_fixed">
                    ...
                    <tbody>
                                ...
                                <table class="border_none">
                                    <tbody>
                                        <tr v-for="(expense_cat, index) in expense_report?.category_wise_data"
                                            ...
                                            <td class="border_left_bottom">
                                                {{
                                                    formatBangla(expense_cat.amount
                                                        ?? '')
                                                }}
                                            </td>
                                        </tr>
                        ...
                        <tr>
                            ...
                            <td>{{ formatBangla(income_report?.total_amount) }}</td>
                            <td class="text-end px-2">সর্বমোট</td>
                            <td>{{ formatBangla(expense_report?.total_amount) }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
export default {
    ...
    methods: {
        ...
        formatBangla(input) {
            ...
            return !isNaN(number) && number !== 0 ? number.toLocaleString("bn-BD") : "";
        },
        formatMonth(date) {
