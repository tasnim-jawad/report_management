...
class OrgCityController extends Controller
{
    public function all()
    {
        ...
        $query = OrgCity::where('status', $status)->orderBy($orderBy, $orderByType);
    ...
    {
        $validator = Validator::make(request()->all(), [
            'id' => ['required', 'exists:org_cities,id'],
        ]);
