...
class ThanaMontobboController extends Controller
{
    ...
    {
        return thana_common_get(\App\Models\Report\Thana\Montobbo\ThanaMontobbo::class);
    }

    public function store_single()
    {
        // dd("controller",$this->report_info);
        return thana_common_store($this, \App\Models\Report\Thana\Montobbo\ThanaMontobbo::class, $this->report_info);
    }
}
