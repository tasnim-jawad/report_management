...
class WardDawat4GonoSongjogAndDawatOvijanController extends Controller
{
    ...
    {
        return ward_common_get(WardDawat4GonoSongjogAndDawatOvijan::class);
    }

    public function store_single()
    {
        return ward_common_store($this, WardDawat4GonoSongjogAndDawatOvijan::class, $this->report_info);
    }
    ...
    public function all()
    {
        ...
        $query = WardDawat4GonoSongjogAndDawatOvijan::where('status', $status)->orderBy($orderBy, $orderByType);
    ...
    public function show($id)
    {
        ...
        $data = WardDawat4GonoSongjogAndDawatOvijan::where('id', $id)
            ->select($select)
            ->first();
        if ($data) {
    ...
    public function store()
    {
        ...
        $data = new WardDawat4GonoSongjogAndDawatOvijan();
    ...
    {
        $data = WardDawat4GonoSongjogAndDawatOvijan::find(request()->id);
        if (!$data) {
            return response()->json([
                'err_message' => 'validation error',
    ...
    {
        $validator = Validator::make(request()->all(), [
            'id' => ['required', 'exists:ward_dawat4_gono_songjog_and_dawat_ovijans,id'],
        ]);
