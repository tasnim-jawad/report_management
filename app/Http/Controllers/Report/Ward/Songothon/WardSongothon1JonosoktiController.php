...
class WardSongothon1JonosoktiController extends Controller
{
    ...
    {
        return ward_common_get(WardSongothon1Jonosokti::class);
    }

    public function store_single()
    {
        return ward_common_store($this, WardSongothon1Jonosokti::class, $this->report_info);
    }
