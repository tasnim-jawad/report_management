...
class WardDepartment4DifferentJobHoldersDawatController extends Controller
{
    ...
    public function all()
    {
        ...
        $query = WardDepartment4DifferentJobHoldersDawat::where('status', $status)->orderBy($orderBy, $orderByType);
    ...
    public function show($id)
    {
        ...
        $data = WardDepartment4DifferentJobHoldersDawat::where('id', $id)
            ->select($select)
            ->first();
        if ($data) {
    ...
    public function store()
    {
        ...
        $data = new WardDepartment4DifferentJobHoldersDawat();
    ...
    {
        $data = WardDepartment4DifferentJobHoldersDawat::find(request()->id);
        if (!$data) {
            return response()->json([
                'err_message' => 'validation error',
