...
class Department4DifferentJobHoldersDawatsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Department4DifferentJobHoldersDawat::create([
            'political_and_special_invited' => 23,
            'political_and_special_been_associated' => 12,
            'political_and_special_target' => 32,

            'pesha_jibi_invited' => 25,
            'pesha_jibi_been_associated' => 20,
            'pesha_jibi_target' => 42,

            'olama_masayekh_invited' => 29,
            'olama_masayekh_been_associated' => 21,
            'olama_masayekh_target' => 52,

            'kormo_jibi_mohila_invited' => 28,
            'kormo_jibi_mohila_been_associated' => 22,
            'kormo_jibi_mohila_target' => 22,

            'sromo_jibi_invited' => 27,
            'sromo_jibi_been_associated' => 12,
            'sromo_jibi_target' => 62,

            'media_kormi_invited' => 26,
            'media_kormi_been_associated' => 23,
            'media_kormi_target' => 52,

            'prantik_jonogosti_invited' => 25,
            'prantik_jonogosti_been_associated' => 21,
            'prantik_jonogosti_target' => 42,

            'vinno_dormalombi_invited' => 24,
