...
class UsersTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        User::create([
            ...
            'telegram_name' => "Unit_amir",
            'telegram_id' => "1000", // Slightly different Telegram ID for each user
            'email' => "unit_amir@gmail.com", // Different email for each user
            'password' => bcrypt('12345678'), // Ensure password is hashed
            'blood_group' => (1 % 2 == 0) ? 'O+' : 'A-', // Alternates blood group
        ]);
