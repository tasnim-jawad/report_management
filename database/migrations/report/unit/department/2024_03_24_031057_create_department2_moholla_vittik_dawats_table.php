...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('department2_moholla_vittik_dawats', function (Blueprint $table) {
            ...
            $table->bigInteger('total_village')->nullable();
            $table->bigInteger('total_village_increased')->nullable();

            $table->bigInteger('total_moholla')->nullable();
            $table->bigInteger('total_moholla_increased')->nullable();
            ...
            $table->bigInteger('special_dawat_included')->nullable();
    ...
    {
        Schema::dropIfExists('department2_moholla_vittik_dawats');
    }
};
