...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('dawat4_gono_songjog_and_dawat_ovijans', function (Blueprint $table) {
            ...
            $table->bigInteger('jela_mohanogor_delared_gonosonjog_group')->nullable();
            $table->bigInteger('jela_mohanogor_delared_gonosonjog_attended')->nullable();
            $table->bigInteger('jela_mohanogor_delared_gonosonjog_invited')->nullable();
            $table->bigInteger('jela_mohanogor_delared_gonosonjog_associated_created')->nullable();
